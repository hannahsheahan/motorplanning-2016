...
% the number of colours that you wish to extract from it and uses the
% kmeans++ algorithm (MATLABs prewritten version) to cluster it and find
% what colours to use for plotting. This is stored in the rgb output,
% 'colors' [n x 3 matrix].
